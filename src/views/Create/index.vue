              ...
              <draggable v-model="drapModel" group="drag-drap" animation="300" dragClass="drag-class"
                ...
                <transition-group class="transition-group" tag="section">
                  <div class="form-drap-item" v-for="(o, i) in drapModel" :key="o.key + i" :class="{
                    ...
                    <div v-if="'flexbox' === o.type" :key="o.key">
                      <!-- <FormItem :label="o.title">
                        <Rate v-model="o.value" />
                      </FormItem> -->
                      <Row :gutter="o.gutter">
                    ...
                    <!-- <el-container v-else-if="item.type === 'layout'" :key="item.key">
                      <el-row :class="{ 'dr-area': true, 'dr-active': (localSelector && localSelector.key === item.key)}" style="margin: 2px" :gutter="item.gutter" type="flex" @click.native.stop="selectCommand(index)">
